---
title: "Getting Started with dafrjulia"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with dafrjulia}
...
dafrjulia requires a working Julia installation (>= 1.10). Install Julia from
...
dafrjulia provides a composable query system for extracting and transforming data.
...
- [dafrjulia package documentation](https://tanaylab.github.io/dafrjulia/) for the
